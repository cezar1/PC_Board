...
module battery_assembly(clearance,clearance2)
{
    ...
    translate ([-local_length/2-BATT_WIDTH_MAX/2-SIDE_PANEL_ZIPTIE_EXTRA,-BATT_SHIFT_FRONT+local_width/2+TOP_PANEL_EXTENSION_WITDH-BATT_LENGTH/2,0]) rotate([180,0,-90]) battery(clearance=clearance);
}
